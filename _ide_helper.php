 ...
 * Generated for Laravel 5.8.36 on 2020-01-27 21:51:45.
 *
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
                        /** @var \peertxt\Console\Kernel $instance */
...
namespace Jcf\Geocode\Facades { 
    ...
    class Geocode {
         ...
         * @static 
         */ 
        public static function address($address, $params = [])
        {
                        /** @var \Jcf\Geocode\Geocode $instance */
                        return $instance->address($address, $params);
        }
        ...
        {
                        /** @var \Jcf\Geocode\Geocode $instance */
                        return $instance->latLng($lat, $lng);
        }
